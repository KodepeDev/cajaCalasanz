<div class="container-fluid pt-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-0 font-weight-bold">
                <i class="fas fa-chart-pie mr-2 text-primary"></i>Saldos y Liquidez
            </h4>
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="info-box shadow-sm"
                style="border-left:4px solid {{ $totalSaldo >= 0 ? '#007bff' : '#dc3545' }};">
                <span class="info-box-icon"
                    style="background:{{ $totalSaldo >= 0 ? '#007bff' : '#dc3545' }};">
                    <i class="fas fa-wallet"></i>
                </span>
                <div class="info-box-content">
                    <span class="info-box-text text-muted" style="font-size:.75rem;">SALDO TOTAL ACTUAL</span>
                    <span class="info-box-number {{ $totalSaldo >= 0 ? 'text-primary' : 'text-danger' }}"
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm mb-0">
                            <thead class="bg-primary text-white">
                                <tr>
                                    <th>Cuenta</th>
                                    <th style="width:130px">N° Cuenta</th>
                                    <th style="width:90px">Tipo</th>
                                    <th style="width:150px" class="text-right">Saldo (S/.)</th>
                            ...
                            <tfoot>
                                <tr style="background:#e9ecef;border-top:2px solid #ced4da;">
                                    ...
                                    <td class="text-right font-weight-bold py-2">
                                        <span class="{{ $totalSaldo >= 0 ? 'text-primary' : 'text-danger' }}"
        ...
        {{-- ── Right column: projections + future movements ── --}}
        <div class="col-lg-4 mb-4">
            ...
            <div class="card card-secondary">
                        ...
                        <div class="d-flex align-items-center px-4 py-3
                            ...
                            <div class="flex-fill">
                                <div class="text-muted"
                                    style="font-size:.75rem;text-transform:uppercase;letter-spacing:.4px;">
                                    Liquidez en {{ $h['label'] }}
                                </div>
                ...
                <div class="card-footer text-muted" style="font-size:.75rem;">
                    ...
                    Proyección acumulada de movimientos PAGADOS hasta cada fecha.
                </div>
            </div>
