<div class="pt-3">
    ...
    <div class="card card-primary">
        ...
        <div class="card-header d-flex align-items-center">
            ...
            <div>
                <h3 class="card-title mb-0">Nuevo Ingreso por Cliente</h3>
                <br>
                <small class="text-light opacity-75">
                    Registre un movimiento asociado directamente a un cliente o proveedor
                </small>
            </div>
        </div>
        ...
        <div class="px-4 pt-3 pb-2 border-bottom" style="background:#f8f9fa;">
            <div class="d-flex align-items-center" style="font-size:.82rem;">
                ...
                {{-- Paso 1 --}}
                <div class="d-flex align-items-center {{ $customer_id ? 'text-muted' : 'text-primary font-weight-bold' }}">
                    <span class="d-flex align-items-center justify-content-center rounded-circle mr-2"
                        style="width:28px;height:28px;font-size:.78rem;flex-shrink:0;
                               background:{{ $customer_id ? '#28a745' : '#007bff' }};color:#fff;">
                ...
                <div class="d-flex align-items-center
                    ...
                    <span class="d-none d-sm-inline">Agregar conceptos</span>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="row align-items-end mb-3 pb-3 border-bottom">
                <div class="col-md-7">
                    <label class="col-form-label-sm font-weight-bold text-uppercase text-muted">
                        ...
                        <a href="javascript:void(0)" class="text-primary ml-1 small"
                ...
                @if ($customer_name)
                    <div class="col-md-3 mt-2 mt-md-0">
                        <button type="button" wire:click="$emit('buscar_provision')"
                            wire:loading.attr="disabled"
                            class="btn btn-outline-warning">
                            <i class="fas fa-list-alt mr-1"></i> Ver Provisiones
                        </button>
                    </div>
                @endif
            </div>
            ...
            @if ($customer_name && $customer_id)
                <div class="d-flex align-items-center mb-4 p-3 rounded"
                    style="background:linear-gradient(135deg,#fff8e1,#e8f5e9);border-left:4px solid #f59e0b;">
                    <div class="d-flex align-items-center justify-content-center rounded-circle mr-3 flex-shrink-0"
                        style="width:46px;height:46px;background:#f59e0b;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-sm">
                            ...
                            <tbody>
                                ...
                                @if (empty($provisionsCobrar) && empty($provisions))
                                    <tr>
                                        <td colspan="6" class="text-center py-4" style="background:#fafafa;">
                                            <i class="fas fa-search fa-2x d-block mb-2 text-muted"
                                                style="opacity:.35;"></i>
                                            <span class="text-muted">
                                                Busque un cliente, seleccione provisiones o agregue conceptos con el botón ADD
                                            </span>
                                        </td>
                                    </tr>
                                @endif
        ...
        <div class="card-footer d-flex justify-content-between align-items-center flex-wrap" style="gap:.5rem;">
            ...
            <div class="d-flex align-items-center" style="gap:.75rem;">
                ...
                <button type="button" wire:click.prevent="crearMovimiento"
                    ...
                    {{ (!$customer_id || ($total_prov_cobrar + $total_new) <= 0) ? 'disabled' : '' }}>
    ...
    {{-- Modal: selección de provisiones --}}
