    ...
    <div class="container-fluid">
        <div class="card p-4">
            ...
            <div class="card-header">
                <h3 class="card-title">Reporte de Ingresos y gastos</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group mb-2 col-md-2 mt-4 text-center">
                        <div class="btn-group mt-1" role="group" aria-label="">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" wire:click='buscar'
                                onclick="buscar()"><i class="fa fa-search" aria-hidden="true"></i> Buscar</button>
                        </div>
                    </div>
                </div>
                ...
                @if ($url)
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe id="iframe-pdf" wire:loading.remove class="embed-responsive-item"
