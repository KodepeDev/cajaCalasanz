                ...
                <div class="container-fluid spark-screen">
                        ...
                        <div class="col-md-12">
                            <div class="card card-warning">
                                <div class="card-header with-border">
                                    <i class="fa fa-fork"></i><h3 class="box-title"><b>Balance global Categorias</b></h3>
                    ...
                    {{--<div class="col-sm-12 add_top_1">--}}
                                ...
                                <div class="card-body responsive-table">
                                    ...
                                    <div id="lista_item_wrapper" class="table table-bordered">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <?php
                                                ...
                                                ?>
                                                <table style="font-size: <?php echo  $valorletra ?>" id="balance" class="table table-bordered" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                            @if($tipom=="add")
