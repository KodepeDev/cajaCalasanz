...
class ListadoMovimiento extends Component
{
    ...
    public function render()
    {
        ...
        $movimientos = $baseQuery
            ->with(["customer", "account", "student"])
            ->paginate(15);
    ...
    private function buildQuery()
    {
        ...
        if ($this->documento) {
            ...
            if ($customer) {
                ...
                $this->emit(
                    "error",
                    "No existe ningún registro con el documento: {$this->documento}",
                );
            }
        }
    ...
    {
        $this->start = $this->finish = $this->start1 = $this->finish1 =
            $this->hoy;
        $this->cuenta_id = $this->cuenta_id1 = "";
        $this->categoria_id = $this->categoria_id1 = "";
        $this->tipo = $this->tipo1 = "";
